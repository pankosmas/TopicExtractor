...
topic_model = BERTopic(embedding_model=sentence_model1, calculate_probabilities=False, verbose=True)
topics, probs = topic_model.fit_transform(texts, embeddings1)

umap_emb = umap_model.fit_transform(embeddings1)
